    ...
    <section class="min-h-screen bg-gradient-to-br from-indigo-900 to-purple-800 text-white px-4 py-16">
      <div class="max-w-5xl mx-auto space-y-12">
        ...
        <header class="text-center space-y-4">
          <h1 class="text-4xl font-bold text-purple-200">🧠 Abstraksi - Intellectual</h1>
        ...
        <!-- Penjelasan Teori -->
        <div class="bg-[#2d1f4a] p-6 rounded-xl shadow space-y-4 text-slate-300">
          <h2 class="text-xl font-semibold text-purple-300">🧠 Apa itu Abstraksi?</h2>
          <p>
        ...
        <!-- Studi Mini -->
        <div class="bg-purple-900 p-6 rounded-xl shadow text-slate-200 space-y-4">
          <h2 class="text-lg font-semibold text-purple-300">🧪 Studi Mini</h2>
          <p>
        ...
        <!-- Quiz Interaktif -->
        <div class="bg-[#39266c] p-6 rounded-xl shadow text-slate-100">
          <h2 class="text-lg font-semibold text-purple-300 mb-2">🧩 Pilih Informasi Penting:</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label v-for="(opt, index) in options" :key="index" class="flex items-center space-x-2">
              <input type="checkbox" v-model="selected" :value="opt" class="form-checkbox h-5 w-5 text-purple-600" />
              <span>{{ opt }}</span>
            </label>
          </div>
          ...
          <div class="pt-4 text-green-300 font-semibold" v-if="showFeedback && isCorrect">✅ Jawaban benar!</div>
