      ...
      <div class="max-w-5xl mx-auto space-y-10">
        ...
        <div class="bg-[#1f1b2e] p-6 rounded-xl shadow-md space-y-4 text-center">
          ...
          <audio controls class="w-full rounded-lg">
            <source src="/audio/dekomposisi-narasi.mp3" type="audio/mp3" />
        ...
        <div class="bg-[#1e1933] p-6 rounded-xl space-y-4">
          ...
          <div class="space-y-4">
            <div>
              ...
              <label class="block"><input type="checkbox" v-model="answers.q1" value="wrong1" /> Membuat masalah jadi lebih rumit</label>
              <label class="block"><input type="checkbox" v-model="answers.q1" value="right1" /> Memecah masalah jadi bagian kecil</label>
              <label class="block"><input type="checkbox" v-model="answers.q1" value="wrong2" /> Menyalin masalah orang lain</label>
            </div>
            <div>
              <p class="mb-2 text-slate-200">2. Contoh dekomposisi dalam kehidupan sehari-hari:</p>
              <label class="block"><input type="checkbox" v-model="answers.q2" value="wrong3" /> Mengerjakan ujian langsung semua soal</label>
              <label class="block"><input type="checkbox" v-model="answers.q2" value="right2" /> Rutinitas pagi seperti mandi dan sarapan</label>
              <label class="block"><input type="checkbox" v-model="answers.q2" value="wrong4" /> Menunda pekerjaan terus menerus</label>
            </div>
